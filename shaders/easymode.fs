...
// lucy: uncomment this later and comment the hardcoded versions
// uniform COMPAT_PRECISION int FrameDirection;
// uniform COMPAT_PRECISION int FrameCount;
// uniform COMPAT_PRECISION vec2 OutputSize;
// uniform COMPAT_PRECISION vec2 TextureSize;
...
#define HC_VEC_IN vec2(256, 240)
#define HC_VEC vec2(256 * 4, 240 * 4)

COMPAT_PRECISION int FrameDirection;
COMPAT_PRECISION int FrameCount;
COMPAT_PRECISION vec2 OutputSize = HC_VEC_IN;
COMPAT_PRECISION vec2 TextureSize = HC_VEC_IN;
COMPAT_PRECISION vec2 InputSize = HC_VEC_IN;
